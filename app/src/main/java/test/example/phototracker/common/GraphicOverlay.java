...
public class GraphicOverlay extends View {
  ...
  public abstract static class Graphic {
    ...
    public RectF getDrawRect(RectF rect) {
    ...
    public RectF getDrawRect(Rect bounds) {
      return getDrawRect(new RectF(bounds));
    }
  ...
  public GraphicOverlay setTextSize(int textSize) {
    textPaint.setTextSize(textSize);
    return this;
  }

  public GraphicOverlay setTextColor(int color) {
