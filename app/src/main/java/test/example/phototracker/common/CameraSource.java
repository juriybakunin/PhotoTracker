...
package test.example.phototracker.common;
...
public class CameraSource {
  ...
  private static final String TAG = MyLog.DEF_TAG;
  ...
  private float requestedFps = 20.0f;
  ...
  public CameraSource setRequestedFps(float fps){
    requestedFps = fps;
    return this;
  }

  public CameraSource setRequestedPreviewSize(int w, int h){
    requestedPreviewWidth = w;
    requestedPreviewHeight = h;
    return this;
  }
